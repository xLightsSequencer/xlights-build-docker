...
# Build wxwidgets
RUN cd / && \
    git clone --depth=1 --shallow-submodules  --recurse-submodules -b xlights_2025.13 https://github.com/xLightsSequencer/wxWidgets xlights_2025.13 && \
    cd xlights_2025.13 && \
