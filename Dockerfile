...
# Build wxwidgets
RUN cd / && \
    git clone --depth=1 --shallow-submodules  --recurse-submodules -b xlights_2024.20 https://github.com/xLightsSequencer/wxWidgets xlights_2024.20 && \
    cd xlights_2024.20 && \
