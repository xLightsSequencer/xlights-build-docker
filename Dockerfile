...
# Build wxwidgets
RUN cd / && \
    git clone --depth=1 --shallow-submodules  --recurse-submodules -b xlights_2021.13 https://github.com/xLightsSequencer/wxWidgets wxWidgets-2021.13 && \
    cd wxWidgets-2021.13 && \
