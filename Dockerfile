...
# Build wxwidgets
RUN cd / && \
    git clone --depth=1 --shallow-submodules  --recurse-submodules -b xlights_2021.30 https://github.com/xLightsSequencer/wxWidgets wxWidgets-2021.30 && \
    cd wxWidgets-2021.30 && \
